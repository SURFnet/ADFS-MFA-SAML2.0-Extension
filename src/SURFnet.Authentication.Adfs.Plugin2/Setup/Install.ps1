...
{	
	...
	{			
		if(Install-Log4NetConfiguration -InstallDir "$PSScriptroot\config")
		{
			...
			Install-AuthProvider -InstallDir $PSScriptroot -ProviderName ADFS.SCSA2 -AssemblyName "SURFnet.Authentication.Adfs.Plugin2.dll" -TypeName "SURFnet.Authentication.Adfs.Plugin2.Adapter"
