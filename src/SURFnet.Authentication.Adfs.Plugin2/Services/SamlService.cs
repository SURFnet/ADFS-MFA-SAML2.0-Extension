...
namespace SURFnet.Authentication.Adfs.Plugin2.Services
{
    ...
    using SURFnet.Authentication.Adfs.Plugin2.Models;
    using SURFnet.Authentication.Adfs.Plugin2.Properties;
    using SURFnet.Authentication.Adfs.Plugin2.Repositories;
