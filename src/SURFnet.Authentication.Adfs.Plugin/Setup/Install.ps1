...
function InitializeUserSettings() {
	...
	$global:Settings_SchacHomeOrganization = AskRequiredQuestion "SchacHomeOrganization"
	...
	$global:Settings_ActiveDirectoryName = AskRequiredQuestion "ActiveDirectoryName" # TODO: Remove
