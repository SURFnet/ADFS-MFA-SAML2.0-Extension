...
function GetUserSettings() {
	...
	Write-WarningMessage "2. Enter the name of the attribute in AD containing the userid known by SURFsecureID."
	...
	Write-WarningMessage "3. Enter the EntityID of your Service Provider (SP)." 
	...
	Write-WarningMessage "4. Optionally, select (if present) a .pfx file containing the X.509 certificate and RSA private key which will be used to sign the authentication request to the SFO Endpoint" 
