...
namespace SURFnet.Authentication.Adfs.Plugin.Setup.Versions
{
    ...
    {
        static public readonly AssemblySpec Adapter_2_1_Spec = new AssemblySpec(SetupConstants.AdapterFilename)
        {
        ...
        static public readonly AssemblySpec[] V2_1_Extras = new AssemblySpec[]
        {
