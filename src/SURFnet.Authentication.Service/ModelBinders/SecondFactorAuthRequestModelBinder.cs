...
namespace SURFnet.Authentication.Service.ModelBinders
{
    ...
    public class SecondFactorAuthRequestModelBinder : IModelBinder
    {
        ...
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            var result = this.DeserializeRequest(form);
            if (result == null)
            {
                return null;
            }
        ...
        /// <summary>
        /// Deserializes the request to a <see cref="SecondFactorAuthRequest"/> generated by the ADFS plugin.
        /// </summary>
        /// <param name="form">The form.</param>
        /// <returns>A Second Factor Authentication Request.</returns>
        private SecondFactorAuthRequest DeserializeRequest(NameValueCollection form)
        {
            var request = form.Get("request");
            request = Uri.UnescapeDataString(request);
            var result = JsonConvert.DeserializeObject<SecondFactorAuthRequest>(request);
            return result;
        }
    }
}